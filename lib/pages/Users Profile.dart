import 'package:benefitblog/component/Services.dart';
import 'package:benefitblog/component/Users.dart';
import 'package:benefitblog/pages/Login.dart';
...
class _UserProfileState extends State<UserProfile> {
  ...
  _loadUserDetails(User users) {
    Services.getUserDetails().then((users) {
        ...
        title: InkWell(
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => new UserProfile(email)));
            },
          ...
          new IconButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => new UserDetails(email)));
              }),
          IconButton(
